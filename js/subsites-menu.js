...
(function subsitesMenuScript(Drupal) {
  Drupal.behaviors.subsitesMenu = {
    attach: function (context) {
      ...
      const subsitesMenuToggle = document.querySelector('.subsite-extra__header-toggle-button');
      const subsitesMenu = document.querySelector('.subsite-extra-menu');

      subsitesMenuToggle.addEventListener('click', function () {
        subsitesMenuToggle.setAttribute('aria-expanded', subsitesMenuToggle.getAttribute('aria-expanded') === 'true' ? 'false' : 'true');
